...
public class WheeledChassis implements Chassis {
	...
	protected final RegulatedMotor[] pliers;
	...
	public WheeledChassis(Wheel[] wheels, Pliers[] plier, int dim) {
		...
		pliers = new RegulatedMotor[1];
		pliers[0] = plier[0].getMotor();
	 ...
	 * @return the modeler
	 */
	public WheeledChassis cartesianPosition(double x, double y, double angle) {
	 ...
	 * @return the modeler
	 */
	public WheeledChassis polarPosition(double angle, double radius) {
	...
	public void openPliers() {
		master.startSynchronization();
		pliers[0].setAcceleration(1500);
		pliers[0].setSpeed(1500);
		pliers[0].rotate(1200);
		master.endSynchronization();
	}
	 ...
	 * @return the modeler
	 */
	public static PliersModeler modelPliers(RegulatedMotor motor) {
		return new PliersModeler(motor);
	}
	 ...
	 *
	 */
	public static class PliersModeler implements Pliers {
		protected RegulatedMotor motor;
		protected double         gearRatio = 1;
		protected boolean        invert = false;
		 ...
		 *          on the side)
		 */
		public PliersModeler(RegulatedMotor motor) {
			this.motor = motor;
		}
		 ...
		 * @return the modeler
		 */
		public PliersModeler invert(boolean val) {
			invert = val;
			return this;
		}
